...
public class MidtermExam extends JFrame implements ActionListener
{
	...
	private JTextField nameTF, passwordTF, confirmPasswordTF, gmailTF;
	...
	public MidtermExam()
	{
		...
		confirmPasswordTF = new JTextField(20);
		add(confirmPasswordTF);
		confirmPasswordTF.setBounds(150, 80, 200, 20);
	...
	public void actionPerformed(ActionEvent e) 
	{
		if (e.getSource() == submitB)
		{
			...
			getset.setPassword(passwordTF.getText());
			...
			PrintWriter out;
			try {
				out = new PrintWriter(new FileWriter("C:/Users/user/Desktop/didi/Diana/src/output.txt", true), true);
				out.write(getset.getName() + ";" + getset.getPassword() + ";" + getset.getCity() + ";" + getset.getGender() + ";" + getset.getGmail());
			    out.close();
			    Desktop.getDesktop().open(new java.io.File("C:/Users/user/Desktop/didi/Diana/src/output.txt"));
			} 
